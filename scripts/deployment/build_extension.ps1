...
$downloadsDir = Join-Path -Path $rootDir -ChildPath "web\static\downloads"
$extensionDir = Join-Path -Path $rootDir -ChildPath "gnosis_wraith\extension"
$manifestPath = Join-Path -Path $rootDir -ChildPath "gnosis_wraith\extension\manifest.json"
