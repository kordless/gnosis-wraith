    ...
    try:
        ...
        for url in urls:
            try:
                ...
                from core.filename_utils import generate_screenshot_filename
                ...
                if take_screenshot:
                    ...
                    # Get user-specific screenshot directory
                    from core.reports import get_user_screenshots_dir
                    user_screenshots_dir = get_user_screenshots_dir(email)
                    
                    # Ensure directory exists
                    os.makedirs(user_screenshots_dir, exist_ok=True)
                    
                    screenshot_path = os.path.join(user_screenshots_dir, f"{filename}.png")
                    try:
