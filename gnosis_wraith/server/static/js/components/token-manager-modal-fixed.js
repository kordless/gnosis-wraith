 ...
 * Handles provider selection and token input/management with dark styling
 */
      ...
      >
            ...
            {Object.entries(providers).map(([key, config]) => (
              ...
              >
                ...
                {CookieUtils.getCookie(config.cookieName) && (
                  <i className="fas fa-check text-green-400 ml-auto"></i>
                )}
              </button>
            ))}
          </div>
        ...
        <div className="mb-6">
          ...
          <input
            ...
            className="
              w-full px-4 py-3 rounded-lg border-2 border-gray-600
              bg-gray-900 text-gray-800 placeholder-gray-800
        ...
        <div className="flex flex-col space-y-3">
          {/* Save and Clear Current Row */}
          <div className="flex space-x-3">
            <button
              onClick={handleSaveToken}
              disabled={!tokenInput.trim()}
              className="
                flex-1 px-4 py-2 bg-green-700 hover:bg-green-600 
            ...
            {hasCurrentToken() && (
              <button
                ...
                className="
                  px-4 py-2 bg-yellow-700 hover:bg-yellow-600
                  text-white font-semibold rounded-lg
                  transition-colors duration-200
                  flex items-center justify-center space-x-2
                "
          ...
          {/* Clear All Button - Only show if there are tokens to clear */}
          {providersWithTokens.length > 0 && (
            <button
              onClick={handleClearAllTokens}
              className="
                w-full px-4 py-2 bg-red-700 hover:bg-red-600
                text-white font-semibold rounded-lg
                transition-colors duration-200
                flex items-center justify-center space-x-2
              "
